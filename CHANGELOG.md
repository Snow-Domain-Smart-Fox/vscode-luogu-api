...
************************************************************************************
*                                                                                  *
*  7/3/2026 - 11:47 - [BLAME] => 155858750+YANGRENRUIYRR@users.noreply.github.com  *
*                                                                                  *
************************************************************************************
</pre>
...
-
-**Enjoy!**
+# VSCode Luogu API Help Document
+This is a plugin that adds API support to the vscode-luogu plugin, and it needs to be used in conjunction with the Amazing Luogu Tampermonkey plugin.
```
<p><small>This might be a 🚀 or a 🧨 XD</small></p>
<p>&nbsp;</p>
...
************************************************************************************
*                                                                                  *
*  7/3/2026 - 10:21 - [BLAME] => 155858750+YANGRENRUIYRR@users.noreply.github.com  *
*                                                                                  *
************************************************************************************
</pre>
<strong>Message: </strong><br>
"Add support for Vscode Luogu version 4.12.2"<br>

<strong>Affected files: </strong><br>
".gitignore, .vscode-test.mjs, .vscode/extensions.json, .vscode/launch.json, .vscodeignore, CHANGELOG.md, README.md, eslint.config.mjs, extension.js, jsconfig.json, package-lock.json, package.json, test/extension.test.js, vsc-extension-quickstart.md"
...
+# Change Log
+
+All notable changes to the "vscode-luogu-api" extension will be documented in this file.
+
...
+      "version": "0.0.12",
+      "resolved": "https://registry.npmmirror.com/@vscode/test-cli/-/test-cli-0.0.12.tgz",
...
+      "version": "2.5.2",
+      "resolved": "https://registry.npmmirror.com/@vscode/test-electron/-/test-electron-2.5.2.tgz",
...
+      "version": "3.3.4",
+      "resolved": "https://registry.npmmirror.com/flatted/-/flatted-3.3.4.tgz",
...
+    "node_modules/mocha": {
+      "version": "11.7.5",
+      "resolved": "https://registry.npmmirror.com/mocha/-/mocha-11.7.5.tgz",
...
+      "version": "9.3.4",
+      "resolved": "https://registry.npmmirror.com/workerpool/-/workerpool-9.3.4.tgz",
...
+{
+  "name": "vscode-luogu-api",
+  "displayName": "vscode-luogu-api",
+  "description": "Local API service for vscode-luogu: open Luogu pages via localhost in VSCode.",
+  "version": "4.12.2",
+  "engines": {
+    "vscode": "^1.25.0"
+  },
...
+  "contributes": {
+    "configuration":{
+      "title": "Vscode Luogu API",
+      "properties": {
+        "vscode-luogu-api.port":{
+          "type": "integer",
+          "default": 1145,
+          "description": "The port number on which Vscode Luogu API runs (1-65535)",
+          "minimum": 1,
+          "maximum": 65535,
+          "scope":"application"
+        }
